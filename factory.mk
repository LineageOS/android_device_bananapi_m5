...
else ifneq ("$(wildcard vendor/amlogic/m5/radio/bootloader-recovery.img)","")
	$(hide) $(call aml-copy-install-file, vendor/amlogic/m5/radio/bootloader-recovery.img, u-boot.bin)
else
